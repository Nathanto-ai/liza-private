	...
	tests := []struct {
	...
	}{
		{
			...
			wantContains: []string{
				...
				"All state changes MUST go through MCP tools for atomicity, validation, and audit",
				"If no MCP tool exists for an operation",
	...
	tests := []struct {
	...
	}{
		{
			...
			wantContains: []string{
				...
				"Work ONLY in the worktree directory. Use liza_exec with cwd=/project/.worktrees/task-1 for all shell commands.",
